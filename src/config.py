...
DEFAULT_DATASET_PATH = DATA_DIR / _CONFIG['data']['dataset_path']
SAMPLE_TEMPLATE_PATH = DATA_DIR / _CONFIG['data']['template_path']
DATABASE_PATH = DATA_DIR / _CONFIG['database']['path']
